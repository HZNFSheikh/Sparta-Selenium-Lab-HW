...
class SeleniumDemoReg
  ...
  def get_phone_number_field_value
    @chrome_driver.find_element(:name, PHONE_NUMBER_FIELDS)['value']
  end
  ...
  def get_user_name_field_value
    @chrome_driver.find_element(:name, USERNAME_FIELD)['value']
  end
  ...
  def get_about_yourself_value
    @chrome_driver.find_element(:name, DESCRIPTION_FIELD)['value']
  end
